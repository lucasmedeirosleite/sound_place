defmodule SoundPlace.Supervisors.ArtistsSupervisor do
  use Supervisor
  ...
  def transformer_with(supervisor_name, user_id: user_id, artists: artists) do
    worker_with(supervisor_name, [user_id, artists])
  end

  def importer_with(supervisor_name, user_id: user_id, artists: artists) do
    worker_with(supervisor_name, [user_id, artists])
  end
  ...
  defp via_tuple(name) do
    {:via, :gproc, {:n, :l, {:artists_supervisor, name}}}
  end
end
